...
| [worktree-pr](skills/worktree-pr/SKILL.md) | Optionally isolate a task in its own worktree, compare it against the baseline, and preserve separate permission for committing, pushing, and opening a PR. |
<!-- skills:end -->
